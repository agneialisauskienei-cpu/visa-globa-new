...
export async function POST(req: NextRequest, context: Params) {
  try {
    ...
    await writeServerAudit({ supabase, organizationId, actorUserId: userId, tableName: "personnel_trainings", recordId: id, action: "training.rejected", before: previous, after: data });
