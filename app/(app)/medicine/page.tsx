              ...
              <div
                ...
                <label
                  style={{
                    ...
                    alignItems: "center",
                    gap: 10,
                    border: prepareAcknowledged ? "1px solid #10b981" : "1px solid #fecdd3",
                    background: prepareAcknowledged ? "#ecfdf5" : "#fff1f2",
                    borderRadius: 14,
                    padding: "11px 12px",
                    cursor: "pointer",
                  }}
              ...
              <div
                ...
                <label
                  style={{
                    ...
                    alignItems: "center",
                    gap: 10,
                    border: confirmChecks.responsibility_acknowledged ? "1px solid #10b981" : "1px solid #fecdd3",
                    background: confirmChecks.responsibility_acknowledged ? "#ecfdf5" : "#fff1f2",
                    borderRadius: 14,
                    padding: "11px 12px",
                    cursor: "pointer",
                  }}
...
const styles: Record<string, React.CSSProperties> = {
  page: { minHeight: "100vh", background: "#ffffff", padding: 24, color: "#10251f", maxWidth: 1500, margin: "0 auto", fontFamily: "'Segoe UI', Arial, Helvetica, sans-serif" },
  topShell: {
    marginBottom: 18,
    overflow: "visible",
  ...
  moduleNavButtonActive: {
    ...
    fontWeight: 900,
    cursor: "pointer",
    boxShadow: "0 1px 3px rgba(16,37,31,.08)",
  },
  moduleNavRight: {
    marginLeft: "auto",
    display: "flex",
  ...
  statIconGreen: { width: 52, height: 52, borderRadius: 16, background: "#f7fcf9", color: "#486b5d", display: "flex", alignItems: "center", justifyContent: "center" },
  statIconAmber: { width: 52, height: 52, borderRadius: 16, background: "#fff1f2", color: "#be123c", display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  tabsBar: { display: "flex", flexWrap: "wrap", gap: 8, borderRadius: 16, background: "#f7fcf9", padding: 8, border: "1px solid #dbe6e0" },
  ...
  disclaimer: { marginTop: 16, background: "#fff1f2", border: "1px solid #fecdd3", color: "#be123c", borderRadius: 16, padding: 16, display: "flex", gap: 12, alignItems: "flex-start", fontSize: 14, fontWeight: 800, lineHeight: 1.55 },
  ...
  statusGreen: { background: "#e9f7ef", color: "#486b5d", borderColor: "#bfe8d1" },
  statusAmber: { background: "#fff1f2", color: "#be123c", borderColor: "#fecdd3" },
