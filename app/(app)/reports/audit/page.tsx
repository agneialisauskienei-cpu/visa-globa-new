import Link from "next/link"
  ...
  const focusItems = [
    "Jautrių duomenų peržiūros",
"Teisių pakeitimai",
"Eksportai į PDF / XLS / CSV",
"Nepavykę prisijungimai arba veiksmai",
"Rizikingi veiksmai",
"Ištrinti arba archyvuoti įrašai"
  ]
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-4xl text-lg font-bold text-slate-500">
                  Sistemos pakeitimai, jautrių duomenų peržiūros, eksportai, teisės ir BDAR pėdsakas.
                </p>
              </div>
