import Link from "next/link"
  ...
  const focusItems = [
    "Neperžiūrėti perdavimo įrašai",
"Kritinės žymos",
"Neatlikti veiksmai po perdavimo",
"Perduoti slaugai / socialiniam darbuotojui",
"Įrašai be patvirtinimo",
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <h1 className="mt-3 text-5xl font-black tracking-tight text-slate-950">
                  Perdavimo žurnalų ataskaita
                </h1>

                <p className="mt-3 max-w-4xl text-lg font-bold text-slate-500">
                  Pamainų perdavimai, neperžiūrėti įrašai, kritinės žymos ir atsakomybės tęstinumas.
                </p>
              </div>
