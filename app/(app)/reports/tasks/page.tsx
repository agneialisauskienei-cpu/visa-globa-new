...
"Skubios užduotys",
"Pasikartojančios neatliktos užduotys",
"Užduotys be atsakingo darbuotojo",
"Užduotys su neaiškiu terminu",
"Neuždarytos priežiūros užduotys"
  ]
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-4xl text-lg font-bold text-slate-500">
                  Užduočių vykdymas, vėlavimai, skubumas, atsakingi darbuotojai ir pasikartojančios užduotys.
                </p>
              </div>
