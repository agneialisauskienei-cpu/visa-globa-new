            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex min-w-[150px] flex-col items-stretch gap-2">
                <button
                  ...
                  onClick={loadStats}
                  disabled={loading}
                  className="inline-flex items-center justify-start gap-2 rounded-lg bg-white px-4 py-2 text-sm font-black text-[#486b5d] shadow-sm transition active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
                >
    ...
    <article className="rounded-2xl border border-[#dbe6e0] bg-white p-4 transition hover:border-[#486b5d] hover:ring-2 hover:ring-[#486b5d]">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm font-bold text-[#10251f]">{desc}</p>
        </div>
        <span
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#486b5d] bg-white text-[#486b5d]"
          title={badge}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/35 p-4 backdrop-blur-sm">
      <div className="w-full max-w-5xl overflow-hidden rounded-3xl border border-[#c9d8d0] bg-white shadow-2xl">
        <div className="flex items-start justify-between gap-6 border-b border-[#dbe6e0] bg-white px-5 py-4">
          <div>
            <p className="mb-2 text-[11px] font-black uppercase tracking-[0.18em] text-[#486b5d]">
              Trumpa instrukcija
            </p>
            <h1 className="text-3xl font-black text-[#486b5d] sm:text-4xl">{help.title}</h1>
            <p className="mt-3 max-w-3xl text-sm font-bold leading-6 text-[#10251f]">{help.intro}</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            {help.steps.map(([number, title, desc]) => (
              <div key={number} className="rounded-xl border border-[#dbe6e0] bg-white p-4">
                ...
                <p className="text-sm font-bold leading-6 text-[#10251f]">{desc}</p>
              </div>
            ))}
          </div>
        </div>
